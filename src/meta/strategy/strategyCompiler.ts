...
import { StrategyDNA, StrategyPerformance } from "./strategyTypes";

export class StrategyCompiler {

  private strategies: StrategyDNA[] = [];

  compileFromHistory(history: StrategyPerformance[]) {

    const map = new Map<string, StrategyDNA>();
