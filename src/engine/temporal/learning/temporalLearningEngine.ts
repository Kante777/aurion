...
export class TemporalLearningEngine {

  private eventLog: EventRecord[] = [];

  private scores = new Map<string, LeadLagScore>([
   ...
   */
  detectFirstMover(windowMs: number = 5000) {
   ...
   */
  learnFromEventFlow(windowMs: number = 5000) {
   ...
   */
  private updateLeader(instrument: string) {
   ...
   */
  private updateFollower(instrument: string) {
