export class ShockActionEngine {
    ...
    decide(input: {
        ...
        // 🧠 BIAS LOGIC
        if (predictedOutcome === "CRASH") bias = "BEARISH";
        if (predictedOutcome === "REVERSAL") bias = "NEUTRAL";
        if (predictedOutcome === "CONTINUATION") bias = "BULLISH";

        // 🧠 POSITION SIZING HINT
        const positionSizingHint =
